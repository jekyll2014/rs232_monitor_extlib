...
using RS232_monitor_extlib.Properties;
...
*/
        private SerialPortStream serialPort1 = new SerialPortStream();
        private SerialPortStream serialPort2 = new SerialPortStream();
        private SerialPortStream serialPort3 = new SerialPortStream();
        private SerialPortStream serialPort4 = new SerialPortStream();
        ...
        private void CheckBox_RTS1_CheckedChanged(object sender, EventArgs e)
        {
            ...
            dataRowPIN1["Mark"] = checkBox_Mark.Checked;
            var outStr = "";
            if (serialPort1.RtsEnable && o_rts1 == false && serialPort1.Handshake != Handshake.Rts &&
                serialPort1.Handshake != Handshake.XOn)
            {
                o_rts1 = true;
        ...
        private void SerialPopulate()
        {
            ...
            //Add ports
            foreach (var s in SerialPortStream.GetPortNames())
            {
